...
inputFieldComponentObj.componentObj.style.backgroundImage="url('./Admin/styles/InputFieldImage.svg')";
...
imageComponentObj.componentObj.style.backgroundImage="url('./Admin/styles/ImageUpload.png')";
...
judgementComponentObj.componentObj.style.backgroundImage="url('./Admin/styles/Judgement.png')";
...
commentComponentObj.componentObj.style.backgroundImage="url('./Admin/styles/Comment.png')";
